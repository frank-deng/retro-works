10 RANDOMIZE TIMER:DEFINT A-Z:DIM A(4):DIM P(4)
20 CLS:LOCATE 4,9,1:PRINT "*** Bulls and Cows ***";
30 GOSUB 200:T=0:E=0
40 WHILE E=0:LOCATE 6,14:PRINT SPC(24);
50 LOCATE 6,14:PRINT "Guess: ":GOSUB 400
60 IF E=2 THEN GOTO 100
70 GOSUB 300
80 T=T+1:LOCATE 8+T,13:PRINT STR$(T);". ";:PRINT USING "#";P(0);P(1);P(2);P(3);:PRINT USING " #A#B";A;B
90 IF A=4 AND B=0 THEN E=-1 ELSE IF T>=8 THEN E=1
100 WEND
110 IF E>0 THEN LOCATE 19,6:PRINT "You Lose! The answer is: ";:PRINT USING "#";A(0);A(1);A(2);A(3); ELSE LOCATE 19,16:PRINT "You win!";
120 LOCATE 21,12:PRINT "Play again? (Y/N)";
...
400 L=0:LOCATE 6,21
410 LOCATE 6,21+L:KI$=INPUT$(1)
421 K=ASC(KI$)
422 IF K=27 THEN E=2:RETURN
423 IF K=13 AND L=4 THEN E=0:RETURN
424 IF K=8 AND L>0 THEN L=L-1:LOCATE 6,21+L:PRINT " ";:LOCATE 6,21+L:GOTO 410
