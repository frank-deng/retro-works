...
#define INVALID_NUM_POS "Invalid number at row %d, column %d.\n"
#define OPEN_FILE_FAILED "Unable to open sudoku file.\n"
#define INCONSISTENT_NUM_ROW "Invalid number at row %d.\n"
